...
const Bidder = (props) => {
  ...
  const sell=async()=>{
    ...
    if(highestBidder===ctx.accountAddress)
    {
      ...
      ctx.buyNFT(parseInt(props?.data[0]?.tokenId), window.web3.utils.toWei((bidders[0].price), "Ether"))
  ...
  console.log(props?.data[0],ctx.accountAddress)
  return (
      ...
      <div className="bg-[#232323] w-[60%] my-20 px-5 py-5 mx-[5%] rounded-md ">
        <div className="flex justify-between items-baseline px-5">
          ...
          <div className="flex items-center ">
            <p className="text-tertiaryRed mx-2">Ends in: {time} seconds</p>
